...
// Declaración de la función anguloEntreVectores
...
int main() {
  ...
  cout << "Ingrese el operador (+, -, *, v, n, o, a): ";
  cin >> operador;
  ...
  switch (operador) {
    ...
    case 'n':
      ...
      break;
    case 'o':
      resultado = productoGeometrico(vector1, vector2);
      break;
    case 'a':
      resultado = anguloEntreVectores(vector1, vector2);
      break;
    default:
