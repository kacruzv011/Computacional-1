...
void mostrar_menu() {
    std::cout << "\n--- Menú ---" << std::endl;
    std::cout << "1. Método de Euler normal" << std::endl;
    std::cout << "2. Método de Euler mejorado" << std::endl;
    std::cout << "3. Método del trapecio" << std::endl;
...
int main(){
    ...
    //7std::cout<<"Ingrese el tiempo de caida de su caso"<<std::endl;
    //std::cin>> t_f;
    ...
    while (true) {
        ...
        switch (opcion) {
            ...
            case 3: {
                ...
                double a, b;
                int N;
                std::cout << "Introduce el valor inicial (a): ";
                std::cin >> a;
                std::cout << "Introduce el valor final (b): ";
                std::cin >> b;
                std::cout << "Introduce el número de pasos (N): ";
                std::cin >> N;
                trapezoidal(a, b, N);
